<?php
	...
	$ecliptica_title       = "Be One Step Ahead";
	$ecliptica_lorem_ipsum = "Lorem ipsum dolor sit amet, at mei dolore tritani repudiandae. In his nemore temporibus consequuntur, vim ad prima vivendum consetetur. Viderer feugiat at pro, mea aperiam";



    $ecliptica_theme_svg_icons = array(
		'fort-awesome'  => array(
	...
	$ecliptica_theme_divider_style = array(
	...
	$defaults = array(
		...
		"edit_this_text_in_customizer"      => $ecliptica_title,
		'lorem_ipsum'                       => $ecliptica_lorem_ipsum,
		...
		'blog_post_thumb_placeholder_color' => 'rgb(40, 28, 64)',
		'blog_post_excerpt_length'          => 13,
		'assets_js_key'                     => "eclipticaFrontendData",

		'default_icon'                      => $ecliptica_theme_svg_icons['fort-awesome'],
		'icons'                             => $ecliptica_theme_svg_icons,
		'divider_style'                     => $ecliptica_theme_divider_style,
		"gradients"                         => array(
			'night_fade'  =>
				array(
					'name'  => 'night_fade',
		...
		'header_front_page'                 => array(
			...
			'header-menu' => array(
				...
				'props' => array(
					'hoverEffect' => array(
						'type'  => 'none', // HOVER_EFFECT_TYPE_VALUES
						'group' => array(
							'border' => array(
			...
			"hero" => array(
				...
				"style"             => array(
					...
					"background" => array(
						...
						"slideshow" => array(
							"duration" => array( "value" => 3500 ),
							"speed"    => array( "value" => 2300 ),
							"slides"   => array(
								array(
			...
			"social_icons" => array(
				...
				"localProps" => array(
					"icons" => json_encode( array(
						array(
							'icon'       => $ecliptica_theme_svg_icons['facebook-2'],
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $ecliptica_theme_svg_icons['twitter-x'],
							'link_value' => '#',
							'index'      => 1,
						),
						array(
							'icon'       => $ecliptica_theme_svg_icons['instagram'],
							'link_value' => '#',
							'index'      => 2,
						),
						array(
							'icon'       => $ecliptica_theme_svg_icons['youtube-play'],
							'link_value' => '#',
							'index'      => 3,
						),
					) ),
			...
			"icon_list"    => array(
				...
				"localProps" => array(
					"iconList" => json_encode( array(
						array(
							'icon'       => $ecliptica_theme_svg_icons['map-marker'],
							'text'       => 'Location, State, Country',
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $ecliptica_theme_svg_icons['phone'],
							'text'       => '(000) 123 12345',
							'link_value' => 'tel:00012312345',
							'index'      => 1,
						),
						array(
							'icon'       => $ecliptica_theme_svg_icons['envelope'],
				...
				"style" => array(
					"background" => array(
						...
						"video" => array(
							"videoType"   => 'external',
							"externalUrl" => "https://www.youtube.com/watch?v=y5zFszln1ao",
							"internalUrl" => $theme_directory_uri . "/videos/demo-video.mp4",
							"poster"      => array(
								'url' => $theme_directory_uri . "/resources/images/demo-video-cover.jpg"
							)
						),
