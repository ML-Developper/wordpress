...
= How can I customize Ecliptica? =

    To customize the Ecliptica theme you have to open the Customizer by accessing the Appearance menu -> Customizer.


== License ==

Ecliptica WordPress theme, Copyright (C) 2021 ExtendThemes
Ecliptica WordPress theme is licensed under the GPL3.
...
* Images
    ...
    These assets are distributed under the CC0 License
        ...
        Source: https://stocksnap.io/photo/man-running-APW0W8GBMM
...
* Google Fonts:
    ...
    Licensed under SIL Open Font License, 1.1 (https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL)
    Copyright ©  Christian Robertson, Paratype, Font Bureau
