...
_base.ColibriFrontend.getData = function (id) {
    if (window.eclipticaFrontendData && window.eclipticaFrontendData[id]) {
        return window.eclipticaFrontendData[id];
    }
...
var CustomizableVideoBackground = function (_VideoBackground) {
    ...
    _createClass(CustomizableVideoBackground, [{
        ...
        value: function wpCustomize(api) {
            ...
            this.API_URL = ecliptica_ADDITIONAL_JS_DATA.api_url;
