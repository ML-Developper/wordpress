...
<div data-colibri-navigation-overlap="true" role="banner" class="h-navigation_outer <?php echo $component->printNavigationClasses(); ?> style-2-outer style-local-1838-h2-outer">
  <?php ecliptica_theme()->get('inner-top-bar')->render(); ?>
  <div id="navigation" data-sticky-enabled="<?php echo ecliptica_sticky_navigation_is_enabled();?>" data-colibri-component="navigation" data-colibri-id="1838-h2" class="h-section h-navigation h-navigation d-flex style-2 style-local-1838-h2">
    <div class="h-section-grid-container h-section-fluid-container">
      <div>
        <div data-colibri-id="1838-h3" class="h-row-container <?php echo $component->printContainerClasses(); ?> gutters-row-lg-1 gutters-row-md-1 gutters-row-2 gutters-row-v-lg-0 gutters-row-v-md-0 gutters-row-v-2 style-3 style-local-1838-h3 position-relative">
